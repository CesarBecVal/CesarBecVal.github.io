		...
		$('.gallery')
			.on('click', 'a', function(event) {
				...
				var $a = $(this),
					...
					$githubButton = $modal.find('.github-button'),
					href = $a.attr('href'),
					githubLink = $a.data('github'); // Nuevo: obtiene el data-github
				...
				// Asigna el link de GitHub si existe, si no lo oculta.
				if (githubLink) {
				$githubButton.attr('href', githubLink).show();
				} else {
				$githubButton.hide();
				}
			...
			.prepend('<div class="modal" tabIndex="-1"><div class="inner"><img src="" /><div class="content"><h3 class="title"></h3><p class="description"></p><a href="#" target="_blank" class="button github-button">View</a></div></div></div>')
				.find('img')
